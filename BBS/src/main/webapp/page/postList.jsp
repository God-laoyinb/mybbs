...
<body>
                ...
                <nav class="main-nav">
	                <div class="menu-top-menu-container">
	                    <ul id="menu-top-menu" class="clearfix">
	                        ...
	                        <li class=""><a href="${pageContext.request.contextPath}/PostList/postList">帖子</a></li>
    ...
    <div class="search-area-wrapper">
	    <div class="search-area container">
	        ...
	        <form id="search-form" class="search-form clearfix"  action="${pageContext.request.contextPath}/PostList/postList" autocomplete="off">
	            <input class="search-term required" type="text" id="keywordid" name="keyword" placeholder="输入关键字" title="请输入关键字" />
	            <input id="search" class="search-btn" type="button" value="全站搜索" />
	         </form>
...
<script>
	...
	function sPageInit(totalCount,currentPage,pageSize){ //分页初始化
		$("#myPage").sPage({ //对分页条进行数据填充
	        ...
	        backFun:function(page){
	        	...
	        	var kw = "{keyword}";
	        	if(''!=kw){
	        		searchPost("${keyword}",page,pageSize);
	        		}
	        }
		});
	};
	...
	function searchPost(keyword,page,pageSize){ //搜索帖子
		...
		if(''!=keyword||keyword!=null){
			$.ajax({
				url:"${pageContext.request.contextPath}/PostList/searchPostByPaging",
				type:"post",
				dataType:"json",
				async:false,
