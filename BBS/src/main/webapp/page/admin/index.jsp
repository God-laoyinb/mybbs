...
<aside class="Hui-aside">
	<div class="menu_dropdown bk_2">
		...
		<dl id="menu-product">
			...
			<dd>
				<ul>
					<li><a data-href="${pageContext.request.contextPath}/PostManage/post-list" data-title="帖子列表" href="javascript:void(0)">帖子列表</a></li>
				</ul>
		</dd>
	   </dl>
		<dl id="menu-member">
			...
			<dd>
				<ul>
					<li><a data-href="${pageContext.request.contextPath}/BlockManage/block-list" data-title="版块管理" href="javascript:void(0)">版块列表</a></li>
				</ul>
		</dd>
	   </dl>
	   ...
	   <dl id="menu-question">
			...
			<dd>
				<ul>
					<li><a data-href="${pageContext.request.contextPath}/UserManage/user-list" data-title="用户列表" href="javascript:void(0)">用户列表</a></li>
...
<script>
	function quit(){ //退出
		$("#quit").click(function(){
			window.location.href="${pageContext.request.contextPath}/AdminIndex/logout";
		});	
