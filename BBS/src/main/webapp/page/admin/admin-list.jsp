	...
	<table class="table table-border table-bordered table-bg">
		...
		<c:forEach items="${adminList}" var="admin">
			<tr class="text-c">
				...
				<td class="td-status"><span class="label label-success radius">${admin.state}</span></td>
				<td class="td-manage"><a title="编辑" href="javascript:;" onclick="admin_edit('编辑','${pageContext.request.contextPath}/AdminManage/admin-update?id=${admin.id}&adminName=${admin.adminName}&password=${admin.password}','1','800','500','${admin.adminName}')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a> </td>
